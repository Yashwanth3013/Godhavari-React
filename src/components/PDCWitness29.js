...
const PDCWitness29 = () => {
    ...
    const prosche = () => {
        window.location.href = "/DocumentfoApproval1";
       };
  ...
  return (
    ...
    <div class="card shadow-lg bg-white rounded m-5">
         ...
         >
          ...
          <h3 className='m-4'><b>Enter the Details</b></h3>
          ...
          <div class="btn-group" role="group" >
            ...
            <button type="button" class="btn btn-primary btn-lg disabled" >WITNESS 1</button>
            <button type="button" class="btn btn-primary btn-lg " >WITNESS 2 <button type="button" class="btn-close text-white " style={{float:"right"}} ></button></button>
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div style={{position: "relative", top:"200px",marginTop:"20px",marginLeft:"350px"}}>
