...
const PDetailsPresenter = () => {
    ...
    const prosche = () => {
        window.location.href = "/PartyDetailsExecutant1";
       };
    ...
    <div class="card shadow-lg bg-white rounded m-5">
      ...
      <div class="card shadow-lg bg-white rounded-3 m-5 " style={{width:"1000px",height: "2009px",marginLeft:"30px",marginTop:"30px" }} >
          ...
          <div class="btn-group" role="group" >
            ...
            <button type="button" class="btn btn-primary btn-lg" style={{width:'50px'}} >PRESENTER</button>
        ...
        <div class="row ml-4" style={{marginTop:'50px'}}>
                  ...
                  <p>Who is presenting</p> 
                  </div>
                  <div className="col-md-3">
                  <div class="form-check">
                  <input type="radio"/>
                  <label class="form-check-label"><span style={{color:'#3D3D3D',marginLeft:'10px'}}>Claimant</span></label>
                  </div> 
                  </div>
                  <div className="col-md-3">
                  <div class="form-check">
                  <input  type="radio"/>
                  <label class="form-check-label"><span style={{color:'#3D3D3D',marginLeft:'10px'}}>Executant</span></label>
                  </div> 
                  </div>
                  </div>
                  ...
                  <label class="form-check-label"><span style={{color:'#3D3D3D',marginLeft:'10px'}}>Individual</span></label>
                  </div> 
                  </div>
                  <div className="col-md-3">
                  <div class="form-check">
                  <input  type="radio"/>
                  <label class="form-check-label"><span style={{color:'#3D3D3D',marginLeft:'10px'}}>Organization</span></label>
                  </div> 
                  </div>
                  </div>
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div style={{position: "relative",marginTop:"30px",marginLeft:"350px"}}>
...
export default PDetailsPresenter;
