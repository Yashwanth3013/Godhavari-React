...
const PDetailsExecutant = () => {
    ...
    const prosche = () => {
        window.location.href = "/PartyDetailsExecutant2";
       };
    ...
    <div class="card shadow-lg bg-white rounded m-5">
         ...
         >
          ...
          <div class="btn-group" role="group" >
            ...
            <button type="button" class="btn btn-primary btn-lg" style={{width:'30px'}} >EXECUTANT 1</button>
             <button type="button" class="btn-close text-white" style={{float:"right"}} ></button><button type="button" class="btn-close text-white " style={{float:"right"}} ></button>
        ...
        <div class="row ml-4" style={{marginTop:'50px'}}>
                  ...
                  <label class="form-check-label"><span style={{color:'#3D3D3D',marginLeft:'10px'}}>Yes</span></label>
                  </div> 
                  </div>
                  <div className="col-md-3">
                  <div class="form-check">
                  <input name="a" type="radio"/>
                  <label class="form-check-label"><span style={{color:'#3D3D3D',marginLeft:'10px'}}>No</span></label>
                  </div> 
                  </div>
                  </div>
                  ...
                  <label class="form-check-label"><span style={{color:'#3D3D3D',marginLeft:'10px',marginTop:'20px'}}>Individual</span></label>
                  </div> 
                  </div>
                  <div className="col-md-3">
                  <div class="form-check">
                  <input name="b" type="radio"/>
                  <label class="form-check-label"><span style={{color:'#3D3D3D',marginLeft:'10px',marginTop:'20px'}}>Organization</span></label>
                  </div> 
                  </div>
                  </div>
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <button style={{width:'140px',height:'40px'}}type="button rounded" class="btn btn-outline-primary">Upload Form 60/61</button>
                </div>
                </div>
                ...
                <button onClick={prosche} class="btn btn-primary btn-lg" >Save and Continue</button>
                </div>
                </div>
...
export default PDetailsExecutant;
